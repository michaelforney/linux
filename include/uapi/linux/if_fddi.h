...
struct __attribute__((packed)) fddi_8022_1_hdr {
...
struct __attribute__((packed)) fddi_8022_2_hdr {
	__u8	dsap;			/* destination service access point */
	__u8	ssap;			/* source service access point */
...
struct __attribute__((packed)) fddi_snap_hdr {
...
struct __attribute__((packed)) fddihdr {
