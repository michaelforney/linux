...
struct __attribute__((packed)) pisp_agc_statistics_zone {
	__u64 Y_sum;
	__u32 counted;
	__u32 pad;
};

struct __attribute__((packed)) pisp_agc_statistics {
...
struct __attribute__((packed)) pisp_awb_statistics_zone {
	__u32 R_sum;
	__u32 G_sum;
	__u32 B_sum;
	__u32 counted;
...
struct __attribute__((packed)) pisp_awb_statistics {
...
struct __attribute__((packed)) pisp_cdaf_statistics {
	__u64 foms[PISP_CDAF_STATS_NUM_FOMS];
	__u64 floating[PISP_FLOATING_STATS_NUM_ZONES];
};

struct __attribute__((packed)) pisp_statistics {
