...
struct __attribute__((packed)) hippi_fp_hdr {
#if 0
...
struct __attribute__((packed)) hippi_le_hdr {
#if defined (__BIG_ENDIAN_BITFIELD)
	__u8		fc:3;
	__u8		double_wide:1;
	__u8		message_type:4;
 ...
 */
struct __attribute__((packed)) hippi_snap_hdr {
...
struct __attribute__((packed)) hippi_hdr {
